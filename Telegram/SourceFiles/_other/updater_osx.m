...
NSString *appName = @"BoltuGram.app";
NSString *appDir = nil;
...
void RemoveQuarantineFromBundle(NSString *path) {
	...
	RemoveQuarantineAttribute([path stringByAppendingString:@"/Contents/MacOS/BoltuGram"]);
...
int main(int argc, const char * argv[]) {
	...
	if (update) {
		...
		// so it won't be deleted when we will clear the "BoltuGram.app/Contents" folder.
