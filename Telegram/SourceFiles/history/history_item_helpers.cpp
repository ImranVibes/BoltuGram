...
[[nodiscard]] TextWithEntities UnsupportedMessageText() {
	const auto siteLink = u"https://t.me/boltugram"_q;
	auto result = TextWithEntities{
		tr::lng_message_unsupported(tr::now, lt_link, siteLink).replace("Telegram", "BoltuGram")
	};
...
HistoryMessageMarkupData UnsupportedMessageMarkup() {
	...
	row.emplace_back(
		Button::Type::Url,
		tr::lng_update_telegram(tr::now).replace("Telegram", "BoltuGram"),
		Button::Visual(),
		QByteArray("https://t.me/boltugram"));
