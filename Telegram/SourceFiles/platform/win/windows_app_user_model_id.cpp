...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"BoltuGram.BoltuGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"BoltuGram.BoltuGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"BoltuGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"BoltuGram Desktop/BoltuGram.lnk"_q;
	const auto old = u"BoltuGram for Windows/BoltuGram.lnk"_q;
